...
namespace PowerSystemTweek
{
    ...
    public class PowerSystemTweakPlugin : BaseUnityPlugin
    {
        ...
        public void Start()
        {
            ...
            configPreferCleanEnergyGenerator = Config.Bind("General", "PreferCleanEnergyGenerator", true, "Whether use energy from clean energy generators before using energy generated by fuel");
